...
static_specs = {
    ...
    "catalina.out"              : All([PatternSpec(r"var/log/tomcat/catalina\.out", large_content=True),
                                    PatternSpec(r"var/log/tomcat6/catalina\.out", large_content=True),
                                    PatternSpec(r"tomcat-logs/tomcat/catalina\.out", large_content=True),
                                    PatternSpec(r"tomcat-logs/tomcat6/catalina\.out", large_content=True)]),
    "catalina_server_log"       : All([PatternSpec("var/log/tomcat/logs/catalina.*\.log", large_content=True),
                                    PatternSpec(r"var/log/tomcat6/logs/catalina.*\.log", large_content=True),
                                    PatternSpec(r"tomcat-logs/tomcat/catalina.*\.log", large_content=True),
                                    PatternSpec(r"tomcat-logs/tomcat6/catalina.*\.log", large_content=True)]),
    ...
    "dirsrv_access"             : PatternSpec("var/log/dirsrv/.*/(access|access\.2.*)"),
    "dirsrv_errors"             : PatternSpec("var/log/dirsrv/.*/(errors|errors\.2.*)"),
    ...
    "docker_container_inspect"  : NoneGroup([DockerHostCommandSpec("/usr/bin/docker inspect {docker_containers}", docker_containers=r"\S+")]),
    "docker_image_inspect"      : NoneGroup([DockerHostCommandSpec("/usr/bin/docker inspect {docker_images}", docker_images=r"\S+")]),
    ...
    "hammer_task_list"          : CommandSpec("/usr/bin/hammer --csv task list"),
    ...
    "ip-s_link"                 : CommandSpec("/sbin/ip -s link"),
    ...
    "lvs_noheadings_all"        : CommandSpec("/sbin/lvs --nameprefixes --noheadings --separator='|' -a -o lv_name,lv_size,lv_attr,mirror_log,vg_name,devices,region_size,data_percent,metadata_percent --config='global{locking_type=0} devices{filter=[\"a|.*|\"]}'"),
    "manila_conf"               : SimpleFileSpec("etc/manila/manila.conf"),
    ...
    "mongod_conf"               : First([PatternSpec("etc/mongod.conf"),
                                    PatternSpec("etc/mongodb.conf")]),
    "rh_mongodb26_conf"         : PatternSpec("etc/opt/rh/rh-mongodb26/mongod.conf"),
    ...
    "nginx_conf"                : All([PatternSpec("etc/nginx/nginx.conf"),
                                    PatternSpec("etc/opt/rh/rh-nginx112/nginx/nginx.conf"),
                                    PatternSpec("opt/rh/nginx14/root/etc/nginx/nginx.conf"),
    ...
    "proc_snmp_ipv6"            : SimpleFileSpec("proc/net/snmp6"),
    ...
    "pvs_noheadings_all"        : CommandSpec("/sbin/pvs --nameprefixes --noheadings --separator='|' -a -o pv_all,vg_name --config='global{locking_type=0} devices{filter=[\"a|.*|\"]}'"),
    ...
    "sysconfig_mongod"          : PatternSpec("etc/sysconfig/mongod"),
    ...
    "systemctl_pulp_resmg"      : CommandSpec("/bin/systemctl show pulp_resource_manager"),
    ...
    "tomcat_web.xml"            : All([PatternSpec(r"etc/tomcat/web\.xml"),
                                    PatternSpec(r"etc/tomcat6/web\.xml"),
                                    PatternSpec(r"conf/tomcat/tomcat/web\.xml"),
                                    PatternSpec(r"conf/tomcat/tomcat6/web\.xml")]),
    ...
    "vgs_noheadings_all"        : CommandSpec("/sbin/vgs --nameprefixes --noheadings --separator='|' -a -o vg_all --config='global{locking_type=0} devices{filter=[\"a|.*|\"]}'"),
    ...
    "x86_pti_enabled"           : SimpleFileSpec("sys/kernel/debug/x86/pti_enabled"),
    "x86_ibpb_enabled"          : SimpleFileSpec("sys/kernel/debug/x86/ibpb_enabled"),
    "x86_ibrs_enabled"          : SimpleFileSpec("sys/kernel/debug/x86/ibrs_enabled"),
